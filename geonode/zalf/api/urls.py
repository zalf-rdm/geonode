...
urlpatterns = [
    ...
    re_path(r"^datacite-prefixes/$", datacite_prefixes, name="datacite_prefixes"),
    re_path(r"^datacite_metadata/(?P<pk>\d+)/$", datacite_metadata_xml, name="datacite_metadata_xml"),
]
