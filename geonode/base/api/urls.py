...
router.register(r"restrictioncodetype", views.RestrictionCodeTypeViewSet, "restrictioncodetype")
...
router.register(r"relatedIdentifiergeneraltypes", views.ResourceTypeGeneralViewSet, "relatedIdentifiergeneraltypes")
...
router.register(r"research_domains", views.ResearchDomainViewSet, "research_domains")
